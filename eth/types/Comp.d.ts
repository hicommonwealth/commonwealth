...
interface CompInterface extends Interface {
  functions: {
...
export class Comp extends Contract {
  connect(signerOrProvider: Signer | Provider | string): Comp;
  attach(addressOrName: string): Comp;
  deployed(): Promise<Comp>;

  on(event: EventFilter | string, listener: Listener): Comp;
  once(event: EventFilter | string, listener: Listener): Comp;
  addListener(eventName: EventFilter | string, listener: Listener): Comp;
  removeAllListeners(eventName: EventFilter | string): Comp;
  removeListener(eventName: any, listener: Listener): Comp;
  ...
  estimate: {
    ...
    delegates(arg0: string): Promise<BigNumber>;
