...
export class Uni extends Contract {
  ...
  functions: {
    ...
    mintingAllowedAfter(): Promise<BigNumber>;
  ...
  estimate: {
    ...
    minimumTimeBetweenMints(): Promise<BigNumber>;

    mintCap(): Promise<BigNumber>;

    minter(): Promise<BigNumber>;
    ...
    setMinter(minter_: string): Promise<BigNumber>;

    mint(dst: string, rawAmount: BigNumberish): Promise<BigNumber>;
