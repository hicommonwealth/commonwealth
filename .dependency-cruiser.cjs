...
module.exports = {
  ...
  options: {
    ...
    */
    exclude: {
      path: 'node_modules|fs|http|crypto|path|perf_hooks|v8',
    },
    ...
    */
    ...
    reporterOptions: {
      ...
      archi: {
        ...
        */
        collapsePattern: '^(packages/[^/]+|libs/[^/]+|node_modules)',
...
// generated: dependency-cruiser@16.2.0 on 2024-02-16T16:11:15.459Z
