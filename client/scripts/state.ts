...
import { CommunityCategoryAttributes } from 'server/models/community_category';
import { CommunityCategoryTypeAttributes } from 'server/models/community_category_type';
...
export interface IApp {
  ...
  config: {
    ...
    chainCategories?: CommunityCategoryAttributes[];
    chainCategoryTypes?: CommunityCategoryTypeAttributes[];
  };
