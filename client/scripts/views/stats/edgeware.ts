...
const glTotal = generalizedLocks.reduce(
                ...
                callbacks: {
                  label: (tooltipItem, data2) => {
                    ...
                    return dataset.formatter
                      ? dataset.formatter(item, tooltipItem.index)
                      : item.toString();
                  },
                },
              },
              ...
              content: [
                m('.top-line-summary.row', [
                  m('.col-sm-4', [
                    ...
                    m(
                      ...
                      state.participationSummary
                        ? `${formatNumberRound(
                            state.participationSummary.totalETHLocked
                          )} ETH`
                        : '--'
                    ),
                  ]),
                  m('.col-sm-4', [
                    ...
                    m(
                      ...
                      state.participationSummary
                        ? `${formatNumberRound(
                            state.participationSummary.totalETHSignaled
                          )} ETH`
                        : '--'
                    ),
                  ]),
                  m('.col-sm-4', [
                    ...
                    m(
                      ...
                      state.participationSummary
                        ? [
                            moment(
                              state.participationSummary.lastBlockTime * 1000
                            ).twitterLong(true),
                            ` (Block ${formatNumberRound(
                              state.participationSummary.lastBlock.number
                            )})`,
                          ]
                        : '--'
                    ),
                ...
                m(
                  ...
                  !state.participationSummary
                    ? [
                        state.loading &&
                          m('.chart-loading', m(Spinner, { active: true })),
                        state.noData &&
                          m('.chart-loading', [
                    ...
                    : [
                                ...
                                datasets: [
                                  {
                                    ...
                                    formatter: (d) => [
                                      ...
                                      `${formatDate(
                                        new Date(summary.blocknumToTime[d.x])
                                      )} (approx.)`,
                                    ],
                                  },
                                  {
                        ...
                        m(Pie, {
                          ...
                          getData: () => {
                            ...
                            const ethDistribution = [
                              summary.totalETHLocked3mo,
                              summary.totalETHLocked6mo,
                              summary.totalETHLocked12mo,
                              summary.totalETHSignaled,
                            ].reverse();
                            const ethDistributionLabels = [
                              `Locked 3mo: ${formatNumber(
                                summary.totalETHLocked3mo
                              )} ETH`,
                              `Locked 6mo: ${formatNumber(
                                summary.totalETHLocked6mo
                              )} ETH`,
                              `Locked 12mo: ${formatNumber(
                                summary.totalETHLocked12mo
                              )} ETH`,
                              `Signaled: ${formatNumber(
                                summary.totalETHSignaled
                              )} ETH`,
                            ].reverse();
                            return {
                        ...
                        m(Pie, {
                          ...
                          getData: () => {
                            const summary = state.participationSummary;
                            const totalEffectiveETH =
                              summary.totalEffectiveETHLocked +
                              summary.totalEffectiveETHSignaled;
                            const lockersEDG =
                              (4500000000 * summary.totalEffectiveETHLocked) /
                              totalEffectiveETH;
                            const signalersEDG =
                              (4500000000 * summary.totalEffectiveETHSignaled) /
                              totalEffectiveETH;
                            const otherEDG = 500000000;
                            const totalEDG = 5000000000;
                            const edgDistribution = [
                              lockersEDG,
                              signalersEDG,
                              otherEDG,
                            ].reverse();
                            const edgDistributionLabels = [
                              ...
                              `Other: ${((100 * otherEDG) / totalEDG).toFixed(
                                1
                              )}%`,
                            ].reverse();
                            return {
                        ...
                        m(Pie, {
                          ...
                          getData: () => {
                            ...
                            const totalLockedETH = lockDistribution
                              .map((d) => d.value)
                              .reduce((a, b) => a + b, 0);
                            return {
                              title: `Lockers - ${formatNumberRound(
                                totalLockedETH
                              )} ETH (${lockDistribution.length} addresses)`,
                              data: {
                                datasets: [
                                  {
                                    data: lockDistribution.map((d) => d.value),
                                    backgroundColor: getColors(
                                      lockDistribution.length
                                    ).reverse(),
                                    borderWidth: 1,
                                    formatter: (d, index) => [
                                      `${formatNumber(d)} ETH`,
                                    ...
                                    onclick: (index) =>
                                      lookupAddrs(
                                        lockDistribution[index].lockAddrs
                                      ),
                                  },
                                ],
                              },
                        ...
                        m(Pie, {
                          ...
                          getData: () => {
                            const summary = state.participationSummary;
                            const effectiveLocksDistribution = Object.keys(
                              summary.locks
                            )
                              .map((addr) => {
                                return {
                              ...
                              .sort((a, b) => a.value - b.value);
                            return {
                              title: `Lockers Effective ETH - ${formatNumberRound(
                                summary.totalEffectiveETHLocked
                              )} ETH`,
                              data: {
                                datasets: [
                                  {
                                    data: effectiveLocksDistribution.map(
                                      (d) => d.value
                                    ),
                                    backgroundColor: getColors(
                                      effectiveLocksDistribution.length
                                    ).reverse(),
                                    borderWidth: 1,
                                    formatter: (d, index) => {
                                      const pct =
                                    ...
                                    onclick: (index) =>
                                      lookupAddrs(
                                        effectiveLocksDistribution[index]
                                          .lockAddrs
                                      ),
                                  },
                                ],
                        ...
                        m(Pie, {
                          ...
                          getData: () => {
                            const summary = state.participationSummary;
                            const validatingDistribution = Object.keys(
                              summary.validatingLocks
                            )
                              .map((addr) => ({
                                lockAddrs:
                                  summary.validatingLocks[addr].lockAddrs,
                                value: summary.validatingLocks[addr].lockAmt,
                              }))
                              .sort((a, b) => a.value - b.value);
                            const totalValidatingLockedETH = validatingDistribution
                              .map((d) => d.value)
                              .reduce((a, b) => a + b, 0);
                            return {
                              title:
                                'Validating Lockers - ' +
                                `${formatNumberRound(
                                  totalValidatingLockedETH
                                )} ETH ` +
                                `(${validatingDistribution.length} addresses)`,
                              data: {
                                datasets: [
                                  {
                                    data: validatingDistribution.map(
                                      (d) => d.value
                                    ),
                                    backgroundColor: getColors(
                                      validatingDistribution.length
                                    ).reverse(),
                                    borderWidth: 1,
                                    formatter: (d, index) => [
                                      `${formatNumber(d)} ETH`,
                                    ...
                                    onclick: (index) =>
                                      lookupAddrs(
                                        validatingDistribution[index].lockAddrs
                                      ),
                                  },
                                ],
                              },
                        ...
                        m(Pie, {
                          ...
                          getData: () => {
                            const summary = state.participationSummary;
                            const effectiveValDistribution = Object.keys(
                              summary.validatingLocks
                            )
                              .map((addr) => ({
                                lockAddrs:
                                  summary.validatingLocks[addr].lockAddrs,
                                value:
                                  summary.validatingLocks[addr].effectiveValue,
                              }))
                              .sort((a, b) => a.value - b.value);
                            const totalValidatorEffectiveETH = effectiveValDistribution
                              .map((d) => d.value)
                              .reduce((a, b) => a + b, 0);
                            return {
                              title: `Validating Lockers Effective ETH - ${formatNumberRound(
                                totalValidatorEffectiveETH
                              )} ETH`,
                              data: {
                                datasets: [
                                  {
                                    data: effectiveValDistribution.map(
                                      (d) => d.value
                                    ),
                                    backgroundColor: getColors(
                                      effectiveValDistribution.length
                                    ).reverse(),
                                    borderWidth: 1,
                                    formatter: (d, index) => {
                                      const pct =
                                    ...
                                    onclick: (index) =>
                                      lookupAddrs(
                                        effectiveValDistribution[index]
                                          .lockAddrs
                                      ),
                                  },
                                ],
                        ...
                        m(Pie, {
                          ...
                          getData: () => {
                            const summary = state.participationSummary;
                            const signalDistribution = Object.keys(
                              summary.signals
                            )
                              .map((addr) => ({
                              ...
                              .sort((a, b) => a.value - b.value);
                            const totalSignaledETH = signalDistribution
                              .map((d) => d.value)
                              .reduce((a, b) => a + b, 0);
                            return {
                              title:
                                'Signalers - ' +
                                `${formatNumberRound(totalSignaledETH)} ETH (${
                                  signalDistribution.length
                                } addresses)`,
                              data: {
                                datasets: [
                                  {
                                    data: signalDistribution.map(
                                      (d) => d.value
                                    ),
                                    backgroundColor: getColors(
                                      signalDistribution.length
                                    ...
                                    onclick: (index) =>
                                      lookupAddrs(
                                        signalDistribution[index].signalAddrs
                                      ),
                                  },
                                ],
                              },
                        ...
                        m(Pie, {
                          ...
                          getData: () => {
                            const summary = state.participationSummary;
                            const effectiveSignalDistribution = Object.keys(
                              summary.signals
                            )
                              .map((addr) => ({
                                signalAddrs: summary.signals[addr].signalAddrs,
                            ...
                            return {
                              ...
                              data: {
                                datasets: [
                                  {
                                    data: effectiveSignalDistribution.map(
                                      (d) => d.value
                                    ),
                                    backgroundColor: getColors(
                                      effectiveSignalDistribution.length
                                    ).reverse(),
                                    borderWidth: 1,
                                    formatter: (d, index) => {
                                      const pct =
                                    ...
                                    onclick: (index) =>
                                      lookupAddrs(
                                        effectiveSignalDistribution[index]
                                          .signalAddrs
                                      ),
                                  },
                                ],
                        ...
                        m('.gl-disclaimer', [
                          `Total generalized locks: ${formatNumberRound(
                            glTotal
                          )} ETH`,
                        ]),
                        m('.gl-disclaimer', [
                          `Additional effective ETH attributable to generalized locks: ${formatNumberRound(
                            glTotal * 0.8
                          )} ETH`,
                        ]),
                        m('.clear'),
                ...
                m('.form-field', [
                  ...
                  m(
                    '.explanation',
                    'This will fetch all locks and signal actions from the input address'
                  ),
                ]),
                m('.buttons', [
                  m(Button, {
                    ...
                    onclick: async (e) => {
                      ...
                      for (const addr of addrs) {
                        ...
                        if (!isHex(addr)) {
                          alert(
                            'You must input a valid hex encoded Ethereum address'
                          );
                          return;
                        } else if (
                          (addr.length !== 42 && addr.indexOf('0x') !== -1) ||
                          (addr.length !== 40 && addr.indexOf('0x') === -1)
                        ) {
                          alert(
                            'You must input a valid length Ethereum address'
                          );
                          return;
                        }
                      }
                      const formattedAddrs = addrs.map((a) =>
                        a.length === 40 ? `0x${a}` : a
                      );
                      ...
                      for (let i = 0; i < formattedAddrs.length; i++) {
                        ...
                        const lockEvents =
                          state.participationSummary.ethAddrToLockEvent[addr];
                        const signalEvents =
                          state.participationSummary.ethAddrToSignalEvent[addr];
                        if (lockEvents)
                          resultEvents = [...resultEvents, ...lockEvents[0]];
                        if (signalEvents)
                          resultEvents = [...resultEvents, ...signalEvents[0]];
                      }
                    ...
                    label: vnode.state.lookupLoading
                      ? `Looking up ${pluralize(
                          vnode.state.lookupCount,
                          'address'
                        )}...`
                      : 'Lookup',
                  }),
                ...
                state.addressSummary &&
                  m('.lock-lookup-results', [
                    m(
                      'h3',
                      `Found ${pluralize(
                        state.addressSummary.events.length,
                        'participation event'
                      )}`
                    ),
                    m(
                        ...
                        return m('li', [
                          event.type === 'signal'
                            ...
                            : m('h3', [
                                ...
                                event.returnValues.term.toString() === '0' &&
                                  '3 months',
                                event.returnValues.term.toString() === '1' &&
                                  '6 months',
                                event.returnValues.term.toString() === '2' &&
                                  '12 months',
                              ]),
                          event.type === 'signal' &&
                            m('p', [
                          ...
                          event.type === 'signal'
                            ? [
                                ...
                                m(
                                  ...
                                  'EDG Public Key: ' +
                                    `${
                                      event.returnValues.edgewareAddr
                                        .slice(2)
                                        .match(/.{1,64}/g)
                                        .map((key) => `0x${key}`)[0]
                                    }`
                                ...
                                m(
                                  'p',
                                  `ETH counted from signal: ${formatNumber(
                                    event.eth
                                  )}`
                                ),
                              ]
