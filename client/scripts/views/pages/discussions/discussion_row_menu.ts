...
export const ThreadSubscriptionMenuItem: m.Component<{
...
export const ThreadDeletionMenuItem: m.Component<{
  proposal: OffchainThread;
}> = {
  view: (vnode) => {
    const { proposal } = vnode.attrs;
...
export const TopicEditorMenuItem: m.Component<
...
export const StageEditorMenuItem: m.Component<
...
const DiscussionRowMenu: m.Component<
  { proposal: OffchainThread },
  {
        ...
        m(PopoverMenu, {
          ...
          content: [
            ...
            (isAuthor || hasAdminPermissions) &&
              m(StageEditorMenuItem, {
                openStageEditor: () => {
                  vnode.state.stageEditorIsOpen = true;
                },
              }),
            (isAuthor || hasAdminPermissions) &&
              m(ThreadDeletionMenuItem, { proposal }),
          ],
          inline: true,
          trigger: m(Icon, {
