  ...
  view: (vnode) => [
    ...
    m('.stash-actions', [
      m(ActionForm, {
        ...
        actionHandler: (unbondAmount) => (app.user.activeAccount as SubstrateAccount).unbond(unbondAmount),
      }),
      m(ActionForm, {
        isTextInput: true,
        ...
        actionHandler: (keys) => (app.user.activeAccount as SubstrateAccount).setKeys(keys),
      }),
      m(ActionForm, {
        isTextInput: true,
        ...
        actionHandler: (commission) => (app.user.activeAccount as SubstrateAccount).validateTx(commission),
      }),
      vnode.attrs.stashes.length > 0 && m(ActionForm, {
        ...
        actionHandler: () => (app.user.activeAccount as SubstrateAccount).chillTx(),
      }),
    ]),
  ],
};
