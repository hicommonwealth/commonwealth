      ...
      return m('.LinkedProposalsEmbed', [
        (proposal instanceof SubstrateDemocracyProposal ||
          ...
          m('.treasury-embed-section', [
            ...
            app.activeChainId() &&
              m(Button, {
                href: `/${app.activeChainId()}/proposal/referendum/${
                  proposal.getReferendum().identifier
                }`,
                onclick: (e) => {
                  e.preventDefault();
                  m.route.set(
                    `/${app.activeChainId()}/proposal/referendum/${
                      proposal.getReferendum().identifier
                    }`
                  );
                },
      ...
      return m('.LinkedProposalsEmbed', [
        democracyProposals.map((p) =>
          m('.treasury-embed-section', [
            ...
            app.activeChainId() &&
              m(Button, {
                href: `/${app.activeChainId()}/proposal/democracyproposal/${
                  p.identifier
                }`,
                onclick: (e) => {
                  e.preventDefault();
                  m.route.set(
                    `/${app.activeChainId()}/proposal/democracyproposal/${
                      p.identifier
                    }`
                  );
                },
        ...
        councilMotions.map((mo) =>
          m('.treasury-embed-section', [
            ...
            app.activeChainId() &&
              m(Button, {
                href: `/${app.activeChainId()}/proposal/councilmotion/${
                  mo.identifier
                }`,
                onclick: (e) => {
                  e.preventDefault();
                  m.route.set(
                    `/${app.activeChainId()}/proposal/councilmotion/${
                      mo.identifier
                    }`
                  );
                },
