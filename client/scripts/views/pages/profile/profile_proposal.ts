...
> = {
  view: (vnode) => {
    ...
    return m('.ProfileProposal', [
      m('.summary', [
        m(User, {
          user: new AddressInfo(null, author, proposal.authorChain, null),
          linkify: true,
          hideAvatar: true,
        }),
        proposal.kind === OffchainThreadKind.Question
          ...
          : [
              ...
              link(
                ...
                `/${
                  chain || community
                }/proposal/${slug}/${identifier}-${slugify(title)}`,
                'thread',
                {},
        ...
        createdAt && [m.trust(' &middot; '), createdAt.fromNow()],
      ]),
      m('.activity.proposal', [
        ...
        proposal.kind === OffchainThreadKind.Link
          ? link(
              'a.proposal-title',
              `/${chain || community}/proposal/${slug}/${identifier}-${slugify(
                title
              )}`,
              title,
              {},
