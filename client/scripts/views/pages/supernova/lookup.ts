                ...
                m('a.btn', {
                  ...
                  onclick: async (e) => {
                    ...
                    try {
                      ...
                      vnode.state.btcError = e.message;
                    }
                ...
                m('a.btn', {
                  ...
                  onclick: async (e) => {
                    ...
                    try {
                      ...
                      vnode.state.ethError = e.message;
                    }
                    vnode.state.lookupLoading = false;
                    m.redraw();
                  },
            ...
            m('.form-left', [
              vnode.state.ethAddressSummary && m('.lock-lookup-results', [
                ...
                m('ul', {
                  ...
                  import('web3').then(
                    (Web3) => vnode.state.ethAmount = Web3.default.utils.fromWei(txData.returnValues.eth, 'ether'));
                  return m('li', [
                ...
                m('a.btn', {
                  ...
                  onclick: async (e) => {
                    ...
                    try {
                      ...
                      vnode.state.atomError = e.message;
                    }
                    vnode.state.lookupLoading = false;
                    m.redraw();
                  }
