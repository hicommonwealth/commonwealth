    ...
    const typeSelector = m(FormGroup, [
      m(ButtonGroup, { fluid: true, outlined: true }, [
        m(Button, {
          ...
          label: 'Discussion',
          onclick: () => vnode.state.newType = 'Discussion',
        ...
        m(Button, {
          iconLeft: Icons.LINK,
          label: 'Link',
          onclick: () => vnode.state.newType = 'Link',
          ...
          vnode.state.newType === 'Discussion' && m(Form, [
            ...
            m(FormGroup, [
              m(Input, {
                name: 'title',
                placeholder: 'Title',
                onchange: (e) => vnode.state.form.title = (e as any).target.value,
              }),
            ]),
            m(FormGroup, [
              m(QuillEditor, {
            ...
            m(FormGroup, [
              m(Button, {
                ...
                intent: 'primary',
                onclick: () => vnode.state.error = newThread(vnode.state.form, vnode.state.quillEditorState, author),
