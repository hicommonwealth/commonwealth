...
> = {
  view: (vnode) => {
    ...
    const adminsAndMods = app.chain
      ...
      : app.community
      ? app.community.meta.adminsAndMods
      : [];
              ...
              : [
                  ...
                  linkify
                    ? link(
                        ...
                        profile
                          ? `/${
                              m.route.param('scope') || profile.chain
                            }/account/${profile.address}?base=${profile.chain}`
                          : 'javascript:',
                        [
                          profile
                            ? showAddressWithDisplayName
                              ? profile.displayNameWithAddress
                              : profile.displayName
                            : addrShort,
                          getRoleTags(false),
                        ]
        ...
        m('.user-name', [
          ...
          app.cachedIdentityWidget
            ...
            : link(
                'a.user-display-name',
                profile
                  ? `/${m.route.param('scope') || profile.chain}/account/${
                      profile.address
                    }?base=${profile.chain}`
                  : 'javascript:',
                profile
        ...
        m('.user-block-center', [
          ...
          m(
            ...
            [
              ...
              showChainName &&
                (typeof user.chain === 'string' ? user.chain : user.chain.name),
            ]
          ),
        ]),
        m('.user-block-right', [
