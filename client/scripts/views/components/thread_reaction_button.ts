...
import 'components/thread_reaction_button.scss';
...
const ThreadReactionButton: m.Component<
  ReactionButtonAttrs,
  ReactionButtonState
> = {
  view: (vnode) => {
          ...
          if (!app.isLoggedIn()) {
            ...
            if (hasReacted) {
              ...
              app.reactionCounts
                ...
                .then(() => {
                  vnode.state.reactors = reactors.filter(
