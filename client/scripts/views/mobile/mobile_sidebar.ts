...
import Sidebar, { ExternalLinksModule } from 'views/components/sidebar';
import {
  Tabs,
  TabItem,
  Menu,
...
} from '../components/header/login_selector';
...
const MobileSidebar: m.Component<
  {},
  { activeTab: string; showNewThreadOptions: boolean }
> = {
  view: (vnode) => {
    if (!app) return;
