          ...
          hero
            ...
            ? m('.sublayout-hero.token-banner', [
                m(
                  ...
                  `Link ${app.chain.meta.chain.symbol} address to participate in this community`
                ),
              ])
            : '',
          m('.sublayout-body', [
            m('.sublayout-grid', [
              !hideSidebar && m('.sublayout-sidebar-col', [m(Sidebar)]),
              m('.sublayout-main-col', [vnode.children]),
            ]),
          ]),
        ]),
      ]),
