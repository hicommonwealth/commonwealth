import { subgraphRequest } from '../../snapshot_utils';
...
export async function strategy(
  ...
  // const lowerCasedAddressToOriginalAddressMap = (addresses.map((a) => [a.toLowerCase(), a])).reduce((acc, [key, value]) => ({...acc, [key]: value}), {});
