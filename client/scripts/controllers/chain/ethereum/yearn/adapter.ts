...
export default class Token extends IChainAdapter<EthereumCoin, EthereumAccount> {
  ...
  constructor(meta: NodeInfo, app: IApp) {
    super(meta, app);
    this.chain = new YearnChain(this.app);
  ...
  public async initApi() {
    ...
    const api = new YearnAPI(this.meta.address, this.chain.api.currentProvider as any, activeAddress);
    await api.init();
    this.chain.yearnAPI = api;
    await super.initApi();
  }
