...
export default class Yearn extends IChainAdapter<EthereumCoin, EthereumAccount> {
  ...
  public async initApi() {
    ...
    const api = new YearnApi(Erc20Factory.connect, this.meta.address, this.chain.api.currentProvider as any);
    await api.init();
