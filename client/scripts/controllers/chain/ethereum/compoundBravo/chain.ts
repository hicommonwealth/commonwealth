...
import { GovernorBravoDelegate__factory } from 'eth/types';
...
export default class CompoundChain extends EthereumChain {
  ...
  public isBravo: boolean;

  constructor(app: IApp, _isBravo:boolean = false) {
    super(app);
    this.isBravo = _isBravo;
  }
  ...
  public async init(selectedNode: NodeInfo) {
    ...
    this.compoundApi = new CompoundAPI(
      GovernorBravoDelegate__factory.connect,
