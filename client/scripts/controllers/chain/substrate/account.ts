...
export class SubstrateAccount extends Account<SubstrateCoin> {
  ...
  */
  ...
  public nominateTx(nominees: string[]) {
    return this._Chain.createTXModalData(
      this,
      (api: ApiPromise) => api.tx.staking.nominate(nominees),
      'nominate',
  ...
  public batchTx(params: Call[]) {
    ...
    return this._Chain.createTXModalData(
      this,
      (api: ApiPromise) => api.tx.utility.batch(payload),
      'batch',
      'utility',
...
class SubstrateAccounts implements IAccountsModule<SubstrateCoin, SubstrateAccount> {
  ...
  public get validators(): Promise<IValidators> {
    return new Promise(async (resolve) => {
      ...
      const electedInfo = await this._Chain.api.derive.staking.electedInfo();
