...
class SubstrateChain implements IChainModule<SubstrateCoin, SubstrateAccount> {
  ...
  public initChainEntities(): Promise<void> {
    this._fetcher = new SubstrateEvents.StorageFetcher(this._apiPromise as any) as any;
    const subscriber = new SubstrateEvents.Subscriber(this._apiPromise as any) as any;
    const processor = new SubstrateEvents.Processor(this._apiPromise as any) as any;
