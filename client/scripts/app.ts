          ...
          .map((community) => {
            return app.config.communities.add(
              CommunityInfo.fromJSON({
                ...
                defaultChain: app.config.chains.getById(
    ...
    m.route(document.body, '/', {
      ...
      ...(isCustomDomain
        ? {
            ...
            '/notificationsList': importRoute('views/pages/notificationsList', {
              scoped: true,
              deferChain: true,
            }),
            // NEAR
            ...
            '/new/thread': importRoute('views/pages/new_thread', {
              scoped: true,
              deferChain: true,
            }),
            // Profiles
            ...
            '/:scope/notificationsList': redirectRoute(
              () => '/notificationsList'
            ),
        ...
        : {
            ...
            '/whyCommonwealth': importRoute('views/pages/commonwealth/why', {
              scoped: false,
              hideSidebar: true,
            }),
            // Notifications
            ...
            '/notificationsList': redirectRoute(
              () => '/edgeware/notificationsList'
            ),
            '/:scope/notificationsList': importRoute(
              'views/pages/notificationsList',
              { scoped: true, deferChain: true }
            ),
            ...
            '/:scope/new/project': importRoute(
              'views/pages/commonwealth/projects/create',
              { scoped: true }
            ),
            '/:scope/project/:address': importRoute(
              'views/pages/commonwealth/projects/view',
              { scoped: true }
            ),
            ...
            '/:scope/new/collective': importRoute(
              'views/pages/commonwealth/collectives/create',
              { scoped: true }
            ),
