...
Promise.all([
  ...
  m.route(document.body, '/', {
    ...
    ...(isCustomDomain ? {
      ...
      '/info':                   importRoute('views/pages/info', { scoped: true, deferChain: true }),
      ...
      '/:scope/info':              importRoute('views/pages/info', { scoped: true, deferChain: true }),
