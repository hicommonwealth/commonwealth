...
interface CuratedProjectFactoryInterface extends ethers.utils.Interface {
  functions: {
  ...
  decodeFunctionResult(functionFragment: "cwTokenImp", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "getProtocolData",
    data: BytesLike
  ): Result;
...
export class CuratedProjectFactory extends Contract {
  ...
  interface: CuratedProjectFactoryInterface;
  ...
  functions: {
    ...
    cwTokenImp(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    cwTokenImp(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    cwTokenImp(overrides?: CallOverrides): Promise<PopulatedTransaction>;
