...
interface ProjectFactoryInterface extends ethers.utils.Interface {
  functions: {
    ...
    "priceOralceAggregator()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "priceOralceAggregator",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class ProjectFactory extends BaseContract {
  ...
  functions: {
    ...
    priceOralceAggregator(overrides?: CallOverrides): Promise<[string]>;

    projectImp(overrides?: CallOverrides): Promise<[string]>;

    projects(arg0: BytesLike, overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    priceOralceAggregator(overrides?: CallOverrides): Promise<BigNumber>;
