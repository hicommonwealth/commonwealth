...
interface BasicProjectFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class BasicProjectFactory extends Contract {
  ...
  interface: BasicProjectFactoryInterface;
