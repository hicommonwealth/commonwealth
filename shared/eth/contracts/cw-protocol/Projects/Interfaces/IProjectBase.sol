...
interface IProjectBase {
    // TODO: review -- should there be multiple withdraw/back functions one for curator, beneficiary, and curator?
    // TODO: or use same event but define a string field that determines type
