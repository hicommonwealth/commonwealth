...
import { Api, EventKind, ListenerOptions as AaveListenerOptions, RawEvent } from './types';
...
export declare class Listener extends BaseListener<Api, StorageFetcher, Processor, Subscriber, EventKind> {
    ...
    constructor(chain: string, govContractAddress: string, url?: string, skipCatchup?: boolean, verbose?: boolean, discoverReconnectRange?: (c: string) => Promise<IDisconnectedRange>);
    init(): Promise<void>;
