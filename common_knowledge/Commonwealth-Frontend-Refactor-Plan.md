...
- 260203 PR https://github.com/hicommonwealth/commonwealth/pull/13325 — 1.5 Consolidate useForceRerender + useRerender (keep hooks separate; move useRerender to ContestCard + rename)
