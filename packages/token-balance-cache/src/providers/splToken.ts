...
export default class SplTokenBalanceProvider extends BalanceProvider<solw3.Connection, SplTokenBPOpts> {
  ...
  public async getExternalProvider(node: IChainNode): Promise<solw3.Connection> {
