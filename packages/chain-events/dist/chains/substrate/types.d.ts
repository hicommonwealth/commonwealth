import { Header, EventRecord, Extrinsic, Event, IdentityJudgement as SubstrateJudgement } from '@polkadot/types/interfaces';
...
export declare type BalanceString = string;
export declare type BigIntString = string;
export declare type BlockNumber = number;
export declare type AccountId = string;
export declare type RuntimeVersion = number;
export declare enum IdentityJudgement {
    Unknown = "unknown",
    FeePaid = "fee-paid",
...
export declare function parseJudgement(j: SubstrateJudgement): IdentityJudgement;
/**
...
export declare function isEvent(e: Event | Extrinsic): e is Event;
 ...
 */
export declare type IDemocracyProposalEvents = IDemocracyProposed | IDemocracySeconded | IDemocracyTabled;
export declare type IDemocracyReferendumEvents = IDemocracyStarted | IDemocracyVoted | IDemocracyPassed | IDemocracyNotPassed | IDemocracyCancelled | IDemocracyExecuted;
export declare type IDemocracyPreimageEvents = IPreimageNoted | IPreimageUsed | IPreimageInvalid | IPreimageMissing | IPreimageReaped;
export declare type ITreasuryProposalEvents = ITreasuryProposed | ITreasuryRejected | ITreasuryAwarded;
export declare type ICollectiveProposalEvents = ICollectiveProposed | ICollectiveVoted | ICollectiveApproved | ICollectiveDisapproved | ICollectiveExecuted;
export declare type ISignalingProposalEvents = ISignalingNewProposal | ISignalingCommitStarted | ISignalingVotingStarted | ISignalingVotingCompleted;
export declare type ITipProposalEvents = INewTip | ITipVoted | ITipClosing | ITipClosed | ITipRetracted | ITipSlashed;
export declare type ITreasuryBountyEvents = ITreasuryBountyBecameActive | ITreasuryBountyCanceled | ITreasuryBountyClaimed | ITreasuryBountyAwarded | ITreasuryBountyExtended | ITreasuryBountyProposed | ITreasuryBountyRejected;
export {};
