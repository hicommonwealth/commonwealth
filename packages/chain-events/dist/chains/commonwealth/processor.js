...
class Processor extends interfaces_1.IEventProcessor {
    ...
    process(event) {
        return __awaiter(this, void 0, void 0, function* () {
            const log = logging_1.factory.getLogger(logging_1.addPrefix(__filename, [interfaces_1.SupportedNetwork.Commonwealth, this.chain]));
            const kind = type_parser_1.ParseType(event.event, this.chain);
            if (!kind)
                return [];
            try {
