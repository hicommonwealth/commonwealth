...
export declare type Proposal = UnPromisify<ReturnType<IAaveGovernanceV2['getProposalById']>>;
...
export declare type IEventData = IProposalCanceled | IProposalCreated | IProposalExecuted | IProposalQueued | IVoteEmitted | IDelegateChanged | IDelegatedPowerChanged | ITransfer | IApproval;
