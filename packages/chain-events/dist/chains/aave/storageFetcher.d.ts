...
import { Api, IProposalCreated, IProposalCanceled, IProposalQueued, IProposalExecuted, IVoteEmitted } from './types';
declare type IEntityEventData = IProposalCanceled | IProposalCreated | IProposalExecuted | IProposalQueued | IVoteEmitted;
