...
if [[ $overwrite == "y" || $overwrite == "Y" ]]; then
    ...
    echo $COW_MNEMONIC | evmosd keys add "cow" --keyring-backend $KEYRING --home "$HOMEDIR"
	...
	evmosd add-genesis-account "cow" 100000000000000000000000000aevmos --keyring-backend $KEYRING --home "$HOMEDIR"

    # make cow a validator:
    evmosd gentx "cow" 1000000000000000000000aevmos --chain-id $CHAINID
