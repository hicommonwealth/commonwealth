...
exports.constructSubstrateUrl = void 0;
function constructSubstrateUrl(url) {
    const insecureNodes = [
        'localhost',
        '127.0.0.1',
    ];
    ...
    const insecureNodeSubstring = insecureNodes.find((path) => url.indexOf(path) !== -1);
...
exports.constructSubstrateUrl = constructSubstrateUrl;
