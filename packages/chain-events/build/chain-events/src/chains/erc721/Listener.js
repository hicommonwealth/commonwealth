...
class Listener extends Listener_1.Listener {
    ...
    constructor(chain, tokenAddresses, url, tokenNames, verbose) {
        ...
        this.log = logging_1.factory.getLogger((0, logging_1.addPrefix)(__filename, [interfaces_1.SupportedNetwork.ERC721]));
        this._options = {
            url,
            tokenAddresses,
            tokenNames,
    ...
    async init() {
        try {
            this._api = await (0, subscribeFunc_1.createApi)(this._options.url, this._options.tokenAddresses, this._options.tokenNames, 10000);
        }
        catch (error) {
