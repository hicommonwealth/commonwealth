...
function Label(chain, event) {
    switch (event.network) {
        case interfaces_1.SupportedNetwork.Substrate:
            return (0, substrate_1.Label)(event.blockNumber, chain, event.data);
        case interfaces_1.SupportedNetwork.Aave:
            return (0, aave_1.Label)(event.blockNumber, chain, event.data);
        case interfaces_1.SupportedNetwork.Compound:
            return (0, compound_1.Label)(event.blockNumber, chain, event.data);
        case interfaces_1.SupportedNetwork.ERC20:
            return (0, erc20_1.Label)(event.blockNumber, chain, event.data);
        case interfaces_1.SupportedNetwork.ERC721:
            return (0, erc721_1.Label)(event.blockNumber, chain, event.data);
        case interfaces_1.SupportedNetwork.Moloch:
            return (0, moloch_1.Label)(event.blockNumber, chain, event.data);
        case interfaces_1.SupportedNetwork.Commonwealth:
            return (0, commonwealth_1.Label)(event.blockNumber, chain, event.data);
        case interfaces_1.SupportedNetwork.Cosmos:
            return (0, cosmos_1.Label)(event.blockNumber, chain, event.data);
        default:
