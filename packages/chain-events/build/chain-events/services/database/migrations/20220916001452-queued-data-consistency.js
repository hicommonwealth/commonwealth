...
module.exports = {
    up: async (queryInterface, Sequelize) => {
        await queryInterface.sequelize.transaction(async (t) => {
            await queryInterface.addColumn('ChainEventTypes', 'queued', { type: Sequelize.SMALLINT }, { transaction: t });
            ...
            `, { transaction: t });
            await queryInterface.addColumn('ChainEntities', 'queued', { type: Sequelize.SMALLINT }, { transaction: t });
            await queryInterface.sequelize.query(`
            ...
            await queryInterface.sequelize.query(`
                ALTER TABLE "ChainEntities"
                    ALTER COLUMN queued SET NOT NULL;
            `, { transaction: t });
            await queryInterface.addColumn('ChainEvents', 'queued', { type: Sequelize.SMALLINT }, { transaction: t });
            await queryInterface.sequelize.query(`
                UPDATE "ChainEvents"
                SET queued = -1;
            `, { transaction: t });
