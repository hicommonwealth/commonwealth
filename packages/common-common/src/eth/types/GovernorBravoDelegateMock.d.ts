...
interface GovernorBravoDelegateMockInterface extends ethers.utils.Interface {
  functions: {
...
export class GovernorBravoDelegateMock extends Contract {
  ...
  interface: GovernorBravoDelegateMockInterface;
