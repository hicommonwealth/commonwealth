...
interface IBasicProjectFactoryInterface extends ethers.utils.Interface {
  functions: {
    "addAcceptedTokens(address[])": FunctionFragment;
    "createProject(bytes32,bytes32,bytes32,address,address,uint256,uint256)": FunctionFragment;
...
export class IBasicProjectFactory extends Contract {
  ...
  interface: IBasicProjectFactoryInterface;
  ...
  functions: {
    ...
    "createProject(bytes32,bytes32,bytes32,address,address,uint256,uint256)"(
      _name: BytesLike,
      _ipfsHash: BytesLike,
      _url: BytesLike,
      _beneficiary: string,
