...
export default (
  ...
  Thread.associate = (models) => {
    ...
    models.Thread.hasMany(models.OffchainAttachment, {
      foreignKey: 'attachment_id',
      constraints: false,
      scope: { attachable: 'thread' },
    });
    models.Thread.belongsTo(models.OffchainTopic, {
      as: 'topic',
      foreignKey: 'topic_id',
    });
    ...
    models.Thread.hasMany(models.OffchainReaction, {
      foreignKey: 'thread_id',
      as: 'reactions',
    });
    ...
    models.Thread.hasMany(models.OffchainPoll, {
      foreignKey: 'thread_id',
    });
  };
