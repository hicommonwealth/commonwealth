 ...
 * the pnpm script (pnpm run emit-notification) on a Heroku one-off dyno.
 ...
 * type.
 *
 * Example usage: `pnpm run emit-notification -c dydx -w [your-wallet-address]`. This finds a random old dydx
