    ...
    await queryInterface.sequelize.transaction(async (t) => {
      ...
      for (const topic of topics) {
        ...
        const metadata = {
          ...
          description: `Autogenerated from topic: ${topic_name}`,
...
async function findGroup(queryInterface, community_id, metadata, requirements) {
  const findGroupQuery = `
    SELECT id
    FROM "Groups"
    WHERE community_id = :community_id AND metadata::text = :metadata::text AND requirements::text = :requirements::text
  `;
