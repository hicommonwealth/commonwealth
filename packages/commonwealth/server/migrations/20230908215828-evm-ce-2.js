    ...
    return queryInterface.sequelize.transaction(async (transaction) => {
      ...
      if (ethereumResult.length > 0) {
        ...
        const aaveAbi = await queryInterface.sequelize.query(
          `
        INSERT INTO "ContractAbis" (abi, verified, created_at, updated_at, nickname)
        VALUES (
            ?,
            true,
            CURRENT_TIMESTAMP,
                  ...
                  outputs: [
                    {
                      ...
                      internalType:
                        'struct IAaveGovernanceV2.ProposalWithoutVotes',
                      name: '',
                      type: 'tuple',
                    },
                  ],
                  ...
                  outputs: [
                    {
                      ...
                      internalType:
                        'struct IGovernorCompatibilityBravo.Receipt',
                      name: '',
                      type: 'tuple',
                    },
                  ],
            ...
            replacements: [
              JSON.stringify([
                ...
                },
                {
                  ...
                  stateMutability: 'view',
                  outputs: [
                    { type: 'uint96', name: '', internalType: 'uint96' },
                  ],
                  name: 'getPriorVotes',
                  inputs: [
                    {
