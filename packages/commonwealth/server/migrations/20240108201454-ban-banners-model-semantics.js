  ...
  up: async (queryInterface, Sequelize) => {
    await queryInterface.sequelize.transaction(async (transaction) => {
      ...
      await queryInterface.sequelize.query(
        ...
        RENAME CONSTRAINT "CommunityBanners_chain_id_fkey" RENAME TO "CommunityBanners_community_id_fkey"
      `,
        { transaction },
      );
    });
  ...
  down: async (queryInterface, Sequelize) => {
    await queryInterface.sequelize.transaction(async (transaction) => {
      ...
      await queryInterface.sequelize.query(
        `
        ALTER TABLE "CommunityBanners"
        RENAME CONSTRAINT "CommunityBanners_community_id_fkey" RENAME TO "CommunityBanners_chain_id_fkey"
      `,
        { transaction },
      );
    });
