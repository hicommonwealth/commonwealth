  ...
  down: async (queryInterface, Sequelize) => {
    await queryInterface.sequelize.transaction(async (t) => {
      ...
      await queryInterface.createTable('ChainObjectQueries', {
        ...
        object_type: { type: Sequelize.STRING, allowNull: false, references: { model: 'ChainObjectVersions', key: 'id' } },
        query_type: { type: Sequelize.ENUM('INIT', 'ADD', 'UPDATE'), allowNull: false },
        ...
        updated_at: { type: Sequelize.DATE, allowNull: false },
        deleted_at: Sequelize.DATE,
        has_pagination: { type: Sequelize.BOOLEAN, allowNull: false, }
      }, { transaction: t });
