...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.createTable('NotificationCategories', {
    ...
    await queryInterface.createTable('Subscriptions', {
      ...
      subscriber_id: { type: Sequelize.INTEGER, allowNull: false, references: { model: 'Users', key: 'id' } },
      category_id: { type: Sequelize.STRING, allowNull: false, references: { model: 'NotificationCategories', key: 'name' } },
    ...
    await queryInterface.createTable('Notifications', {
      id: { type: Sequelize.INTEGER, primaryKey: true, autoIncrement: true },
      subscription_id: { type: Sequelize.INTEGER, allowNull: false, references: { model: 'Subscriptions', key: 'id' } },
  ...
  down: (queryInterface, Sequelize) => {
    return queryInterface.sequelize.transaction(async (t) => {
      ...
      await queryInterface.dropTable('NotificationCategories', { transaction: t });
    });
  }
};
