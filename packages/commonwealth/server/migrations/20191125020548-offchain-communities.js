...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.sequelize.transaction(async (t) => {
      ...
      // 1.
      await queryInterface.createTable('OffchainCommunities',  {
      ...
      // 2.
      await queryInterface.addColumn('OffchainComments', 'community', {
        type: Sequelize.STRING,
        references: { model: 'OffchainCommunities', key: 'id' },
      }, { transaction: t });

      await queryInterface.addColumn('OffchainThreads', 'community', {
        type: Sequelize.STRING,
        references: { model: 'OffchainCommunities', key: 'id' },
      }, { transaction: t });

      await queryInterface.addColumn('OffchainReactions', 'community', {
        type: Sequelize.STRING,
        references: { model: 'OffchainCommunities', key: 'id' },
      }, { transaction: t });
      ...
      await queryInterface.bulkInsert('OffchainCommunities', newOffchainCommunitiesRecord, { transaction: t });
    });
  },
  ...
  down: (queryInterface, Sequelize) => {
    return queryInterface.sequelize.transaction(async (t) => {
      ...
      await queryInterface.removeColumn('OffchainComments', 'community', { transaction: t });
      await queryInterface.removeColumn('OffchainThreads', 'community', { transaction: t });
      await queryInterface.removeColumn('OffchainReactions', 'community', { transaction: t });
