...
const LpBondingCurveAbi = [
  {
    ...
    inputs: [
      ...
      { name: '_protocolFeePercent', type: 'uint256', internalType: 'uint256' },
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: 'poolLiquidity', type: 'uint256', internalType: 'uint256' },
...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.sequelize.query(
      `
            UPDATE "ContractAbis"
            SET abi = :abi, abi_hash = :abi_hash
            WHERE nickname = 'LPBondingCurve';
        `,
      {
        replacements: {
