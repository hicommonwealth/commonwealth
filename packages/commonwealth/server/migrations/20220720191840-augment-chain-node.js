...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    return queryInterface.sequelize.transaction(async (t) => {
      await queryInterface.addColumn('ChainNodes', 'balance_type', {
        type: Sequelize.STRING,
        allowNull: true
      }, { transaction: t });
      await queryInterface.addColumn('ChainNodes', 'name', {
        type: Sequelize.STRING,
        allowNull: true
      }, { transaction: t });
      await queryInterface.addColumn('ChainNodes', 'description', {
        type: Sequelize.STRING,
        allowNull: true
      }, { transaction: t });
  ...
  down: async (queryInterface, Sequelize) => {
    return queryInterface.sequelize.transaction(async (t) => {
      await queryInterface.removeColumn('ChainNodes', 'balance_type', { transaction: t });
      await queryInterface.removeColumn('ChainNodes', 'name', { transaction: t });
      await queryInterface.removeColumn('ChainNodes', 'description', { transaction: t });
    });
  }
};
