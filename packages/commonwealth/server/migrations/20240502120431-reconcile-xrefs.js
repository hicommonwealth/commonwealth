...
ALTER TABLE ONLY public."CommunitySnapshotSpaces" DROP COLUMN IF EXISTS "id";
ALTER TABLE ONLY public."CommunitySnapshotSpaces"
ADD CONSTRAINT "CommunitySnapshotSpaces_pkey" PRIMARY KEY (community_id, snapshot_space_id);
...
ALTER TABLE public."CommunitySnapshotSpaces" DROP CONSTRAINT IF EXISTS "CommunitySnapshotSpaces_pkey";
