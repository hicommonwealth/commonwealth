module.exports = {
	up: async (queryInterface, Sequelize) => {
	  return queryInterface.sequelize.transaction(async (transaction) => {
			...
			await queryInterface.addColumn('Users', 'selected_chain_id', {
			...
			await queryInterface.removeColumn('Users', 'selectedNodeId', { transaction });
			...
			*/
			...
			await queryInterface.changeColumn('Chains', 'chain_node_id', {
				type: Sequelize.INTEGER,
				allowNull: true,
