...
import type { RmqCENotificationCUD, RmqEntityCUD, } from 'common-common/src/rabbitmq';
import { RascalExchanges, RascalQueues, RascalRoutingKeys, } from 'common-common/src/rabbitmq';
