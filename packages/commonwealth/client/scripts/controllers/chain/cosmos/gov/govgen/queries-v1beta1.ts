import { ProposalStatus } from '@atomone/govgen-types-long/govgen/gov/v1beta1/gov';
import {
  QueryClientImpl,
  ...
  QueryVoteResponse,
  QueryVotesResponse,
} from '@atomone/govgen-types-long/govgen/gov/v1beta1/query';
...
export interface GovgenGovExtension {
  readonly govgen: {
    readonly params: (
...
export function setupGovgenExtension(base: QueryClient): GovgenGovExtension {
