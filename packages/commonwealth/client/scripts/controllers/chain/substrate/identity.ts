...
import type { AccountId, BalanceOf, IdentityInfo, RegistrationJudgement, } from '@polkadot/types/interfaces';
...
import type SubstrateIdentities, { SuperCodec } from './identities';
