...
class OkxSuiWebWalletController extends SuiWebWalletController {
  public name = WalletId.OkxWallet;
  public label = 'OKX Wallet';

  override get available() {
    const availableWallets = getWallets().get();
    // OKX is a specific wallet that should be available
  ...
  override getSuiWalletProvider(): Wallet | null {
    ...
    // Prioritize OKX wallet if available
    const walletPriority = ['okx'];
...
export default OkxSuiWebWalletController;
