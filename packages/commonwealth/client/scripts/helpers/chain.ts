...
export const selectChain = async (
  ...
  // @REACT @TODO: redraw to show API status indicator
  ...
  // @REACT @TODO: Redraw with not-yet-loaded chain and return true to indicate
  return true;
};
...
export const initChain = async (): Promise<void> => {
  ...
  // @REACT @TODO:Finish redraw to remove loading dialog
};
