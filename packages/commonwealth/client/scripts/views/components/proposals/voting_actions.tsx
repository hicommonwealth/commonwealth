...
import { convictionToWeight, SubstrateDemocracyReferendum, } from 'controllers/chain/substrate/democracy_referendum';
import { SubstratePhragmenElection } from 'controllers/chain/substrate/phragmen_election';
import { SubstrateTreasuryProposal } from 'controllers/chain/substrate/treasury_proposal';
import m from 'mithril';
import { AnyProposal, BinaryVote, DepositVote, VotingType } from 'models';

import app from 'state';

import { createTXModal } from 'views/modals/tx_signing_modal';
import { CompoundCancelButton, MolochCancelButton, } from '../../pages/view_proposal/proposal_components';
