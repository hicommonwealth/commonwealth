...
export const NewThreadForm = ({ hasTopics }: NewThreadFormProps) => {
  ...
  const _newThread = async (
    ...
    const body = _quillEditorState?.textContentsAsString;
    _quillEditorState?.disable();
          ...
          <div className="new-thread-form-inputs">
            ...
            {form.kind === ThreadKind.Discussion && (
              <>
                ...
                <div>
                  <ReactQuill
                    ...
                    onChange={(value, delta, source, editor) => {
                      ...
                      console.log('edit', editor.getContents());
                ...
                <ReactQuill value={value1} readOnly={true} theme={'bubble'} />
