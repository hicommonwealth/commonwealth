...
export const dompurifyConfig = {
  ...
  FORBID_ATTR: ['onclick', 'onmouseover', 'onload', 'onerror', 'form', 'input'],
  FORBID_TAGS: ['script', 'custom-element', 'form', 'input'],
  ADD_TAGS: [],
  ADD_ATTR: ['target'],
};
...
export const dompurifyConfigForHTML = {
  ...
  ALLOWED_ATTR: ['src', 'alt', 'title', 'target'],
  FORBID_ATTR: [
    'onclick',
    'onmouseover',
    'onload',
  ...
  FORBID_TAGS: ['script', 'custom-element', 'form', 'input', 'style'],
  ADD_TAGS: [],
  ADD_ATTR: ['target'],
};
