...
export const CWNewStar = (props: IconProps) => {
  ...
  return (
    <svg
      ...
      {...otherProps}
    >
      <path d="m16.669 14.969-1.2 3.256a.5.5 0 0 1-.938 0l-1.2-3.256a.506.506 0 0 0-.3-.3l-3.256-1.2a.5.5 0 0 1 0-.938l3.256-1.2a.505.505 0 0 0 .3-.3l1.2-3.256a.5.5 0 0 1 .938 0l1.2 3.256a.507.507 0 0 0 .3.3l3.256 1.2a.5.5 0 0 1 0 .938l-3.256 1.2a.507.507 0 0 0-.3.3v0ZM19 5v3m1.5-1.5h-3m4.5 2v2m1-1h-2" stroke="#C90"/>
    </svg>
  );
};
