...
export const CWTrendUp = (props: IconProps) => {
  ...
  return (
    <svg
      ...
      {...otherProps}
    >
      <path d="M14.5 3.5L8.5 9.5L6 7L1.5 11.5" stroke="#7B9E3F" stroke-linecap="round" stroke-linejoin="round"></path>

      <path d="M14.5 7.5V3.5H10.5" stroke="#7B9E3F" stroke-linecap="round" stroke-linejoin="round"></path>
    </svg>
  );
};
