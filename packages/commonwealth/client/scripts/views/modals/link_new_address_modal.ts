...
> = {
  view: (vnode) => {
    ...
    const baseName = !!app.chain ? app.chain.meta.base : webWallet.chain;
      ...
      [
        m('.account-item-avatar', [
          m(
            ...
            m(User, {
              user: 
              new AddressInfo( // Mock Address while not within community
                null,
                address,
                !!app.chain ? app.chain.id : webWallet.defaultNetwork,
              ),
                        ...
                        m(LinkAccountItem, {
                          account:
                            typeof addressOrAccount === 'string'
                              ...
                              : addressOrAccount,
                          base: !!app.chain ? app.chain.base : webWallet.chain,
                          targetCommunity,
                          accountVerifiedCallback,
                          errorCallback: (error) => {
                            notifyError(error);
