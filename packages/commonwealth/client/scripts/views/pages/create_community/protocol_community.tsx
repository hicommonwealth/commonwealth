    ...
    <div className="CreateCommunityForm">
      ...
      <CWButton
        ...
        onClick={async () => {
          ...
          try {
            // get querying wallet
            const signingWallet = WebWalletController.Instance.availableWallets(ChainBase.Ethereum)[0]
            ...
            const factory = new web3.eth.Contract(abi as AbiItem[], '0x689Ce208E0f72447D7B23C479756374ACe977913');

            //check that namespace doesnt exist
            const namespace = await factory.methods.getNamespace(web3.utils.asciiToHex(name)).call()
            if(namespace['token'] && namespace['token'] !== '0x0000000000000000000000000000000000000000'){
