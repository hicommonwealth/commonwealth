...
import { IERC1155MetadataURI__factory } from 'common-common/src/eth/types';
...
type CreateERC1155Form = ChainFormFields & EthFormFields;

type CreateERC1155State = ChainFormState & { form: CreateERC1155Form };

export class ERC1155Form extends ClassComponent<EthChainAttrs> {
  private state: CreateERC1155State = {
    message: '',
    loaded: false,
    loading: false,
    saving: false,
  ...
  view(vnode: m.Vnode<EthChainAttrs>) {
    ...
    const updateTokenForum = async () => {
      ...
      const args = {
        ...
        chain_network: ChainNetwork.ERC1155,
            ...
            try {
              ...
              notifyError(
                err.responseJSON?.error ||
                  'Creating new ERC1155 community failed'
              );
            } finally {
