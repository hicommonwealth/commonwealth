...
import { Account, AnyProposal, Comment, ProposalModule } from 'models';
...
import { LinkedProposalsEmbed, LinkedSubstrateProposal, } from './linked_proposals_embed';
import { ProposalSubheader, SubheaderProposalType, } from './proposal_components';
