...
import useFetchTokenUsdRateQuery from './fetchTokenUsdRateDeprecated';
import useFetchTokensUsdRateQuery from './fetchTokensUsdRate';
...
import useSellStakeMutation from './sellStake';
