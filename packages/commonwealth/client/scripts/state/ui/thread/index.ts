...
export const EXCEPTION_CASE_threadCountersStore = createStore<threadCounterStore>()(
    devtools((set) => ({
        totalThreadsInCommunity: 0,
        totalThreadsInCommunityForVoting: 0,
        setTotalThreadsInCommunity: (count) => set({ totalThreadsInCommunity: count }),
        setTotalThreadsInCommunityForVoting: (count) => set({ totalThreadsInCommunityForVoting: count }),
    }))
);
...
// --
// -- THANKS :) --
const useEXCEPTION_CASE_threadCountersStore = createBoundedUseStore(EXCEPTION_CASE_threadCountersStore);
