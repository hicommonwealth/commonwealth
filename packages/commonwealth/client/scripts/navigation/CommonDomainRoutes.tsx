...
import { FeatureFlags } from '../AppProviderWithContext';
...
const ViewSnapshotsProposalPage = lazy(
  () => import('../views/pages/view_snapshot_proposal/index')
);
...
const CommonDomainRoutes = (featureFlags: FeatureFlags) => {
  const ViewThreadPageABTest = featureFlags.discussionsPageFlag
    ? lazy(() => import('views/pages/view_thread/NewViewThreadPage'))
    : lazy(() => import('views/pages/view_thread/ViewThreadPage'));
  ...
  return [
    ...
    <Route
      ...
      element={withLayout(ViewThreadPageABTest, {
        scoped: true,
      })}
    />,
    <Route
