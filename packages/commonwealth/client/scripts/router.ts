...
const getCommonDomainRoutes = (importRoute) => ({
  ...
  // Crowdfund
  '/projects/explore': importRoute(import('views/pages/projects/index'), {
    scoped: false,
    hideSidebar: true,
  }),
  '/projects/yours': importRoute(import('views/pages/projects/index'), {
    scoped: false,
    hideSidebar: true,
  }),
  '/project/:identifier': importRoute(import('views/pages/projects/view_project'), {
    scoped: false,
    hideSidebar: true
  }),
