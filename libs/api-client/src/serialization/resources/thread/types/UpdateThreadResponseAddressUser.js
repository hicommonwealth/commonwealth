...
export const UpdateThreadResponseAddressUser = core.serialization.object({
  ...
  emailNotificationInterval:
    UpdateThreadResponseAddressUserEmailNotificationInterval.optional(),
  ...
  profileTags: core.serialization.property(
    'ProfileTags',
    core.serialization
      .list(UpdateThreadResponseAddressUserProfileTagsItem)
      .optional(),
  ),
  apiKey: core.serialization.property(
    'ApiKey',
    UpdateThreadResponseAddressUserApiKey.optional(),
  ),
