...
export const UpdateThreadResponseTopic = core.serialization.object({
  ...
  weightedVoting: core.serialization.property(
    'weighted_voting',
    UpdateThreadResponseTopicWeightedVoting.optional(),
  ),
  ...
  contestTopics: core.serialization.property(
    'contest_topics',
    core.serialization
      .list(UpdateThreadResponseTopicContestTopicsItem)
      .optional(),
  ),
});
