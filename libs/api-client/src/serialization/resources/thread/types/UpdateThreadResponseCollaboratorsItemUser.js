...
export const UpdateThreadResponseCollaboratorsItemUser =
  core.serialization.object({
    ...
    emailNotificationInterval:
      UpdateThreadResponseCollaboratorsItemUserEmailNotificationInterval.optional(),
    ...
    profileTags: core.serialization.property(
      'ProfileTags',
      core.serialization
        .list(UpdateThreadResponseCollaboratorsItemUserProfileTagsItem)
        .optional(),
    ),
    apiKey: core.serialization.property(
      'ApiKey',
      UpdateThreadResponseCollaboratorsItemUserApiKey.optional(),
    ),
