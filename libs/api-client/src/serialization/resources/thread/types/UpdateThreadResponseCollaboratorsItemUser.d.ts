...
export declare const UpdateThreadResponseCollaboratorsItemUser: core.serialization.ObjectSchema<
...
export declare namespace UpdateThreadResponseCollaboratorsItemUser {
  interface Raw {
    ...
    ProfileTags?:
      | UpdateThreadResponseCollaboratorsItemUserProfileTagsItem.Raw[]
      | null;
