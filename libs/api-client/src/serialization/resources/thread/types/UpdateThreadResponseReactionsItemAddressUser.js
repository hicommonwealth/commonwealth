...
export const UpdateThreadResponseReactionsItemAddressUser =
  core.serialization.object({
    ...
    emailNotificationInterval:
      UpdateThreadResponseReactionsItemAddressUserEmailNotificationInterval.optional(),
    ...
    profileTags: core.serialization.property(
      'ProfileTags',
      core.serialization
        .list(UpdateThreadResponseReactionsItemAddressUserProfileTagsItem)
        .optional(),
    ),
    apiKey: core.serialization.property(
      'ApiKey',
      UpdateThreadResponseReactionsItemAddressUserApiKey.optional(),
    ),
