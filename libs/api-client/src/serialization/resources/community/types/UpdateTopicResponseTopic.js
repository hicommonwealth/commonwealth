...
export const UpdateTopicResponseTopic = core.serialization.object({
  ...
  weightedVoting: core.serialization.property(
    'weighted_voting',
    UpdateTopicResponseTopicWeightedVoting.optional(),
  ),
  ...
  contestTopics: core.serialization.property(
    'contest_topics',
    core.serialization
      .list(UpdateTopicResponseTopicContestTopicsItem)
      .optional(),
  ),
});
