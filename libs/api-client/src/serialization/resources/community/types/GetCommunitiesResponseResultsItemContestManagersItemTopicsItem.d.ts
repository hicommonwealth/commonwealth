...
export declare const GetCommunitiesResponseResultsItemContestManagersItemTopicsItem: core.serialization.ObjectSchema<serializers.GetCommunitiesResponseResultsItemContestManagersItemTopicsItem.Raw, CommonApi.GetCommunitiesResponseResultsItemContestManagersItemTopicsItem>;
export declare namespace GetCommunitiesResponseResultsItemContestManagersItemTopicsItem {
    interface Raw {
        ...
        contest_topics?: GetCommunitiesResponseResultsItemContestManagersItemTopicsItemContestTopicsItem.Raw[] | null;
    }
}
