...
export const CreateCommunityResponseCommunity = core.serialization.object({
  ...
  socialLinks: core.serialization.property(
    'social_links',
    core.serialization
      .list(CreateCommunityResponseCommunitySocialLinksItem)
      .optional(),
  ),
  ...
  defaultPage: core.serialization.property(
    'default_page',
    CreateCommunityResponseCommunityDefaultPage.optional(),
  ),
  hasHomepage: core.serialization.property(
    'has_homepage',
    CreateCommunityResponseCommunityHasHomepage.optional(),
  ),
  ...
  addresses: core.serialization.property(
    'Addresses',
    core.serialization
      .list(CreateCommunityResponseCommunityAddressesItem)
      .optional(),
  ),
  communityStakes: core.serialization.property(
    'CommunityStakes',
    core.serialization
      .list(CreateCommunityResponseCommunityCommunityStakesItem)
      .optional(),
  ),
  communityTags: core.serialization.property(
    'CommunityTags',
    core.serialization
      .list(CreateCommunityResponseCommunityCommunityTagsItem)
      .optional(),
  ),
  chainNode: core.serialization.property(
    'ChainNode',
    CreateCommunityResponseCommunityChainNode.optional(),
  ),
  topics: core.serialization
    .list(CreateCommunityResponseCommunityTopicsItem)
    .optional(),
  groups: core.serialization
    .list(CreateCommunityResponseCommunityGroupsItem)
    .optional(),
  contestManagers: core.serialization.property(
    'contest_managers',
    core.serialization
      .list(CreateCommunityResponseCommunityContestManagersItem)
      .optional(),
  ),
});
