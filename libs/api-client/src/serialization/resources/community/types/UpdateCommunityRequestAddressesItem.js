...
export const UpdateCommunityRequestAddressesItem = core.serialization.object({
  ...
  walletId: core.serialization.property(
    'wallet_id',
    UpdateCommunityRequestAddressesItemWalletId.optional(),
  ),
  ...
  user: core.serialization.property(
    'User',
    UpdateCommunityRequestAddressesItemUser.optional(),
  ),
