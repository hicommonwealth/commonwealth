...
export const GetCommunitiesResponseResultsItemAddressesItemUser =
  core.serialization.object({
    ...
    emailNotificationInterval:
      GetCommunitiesResponseResultsItemAddressesItemUserEmailNotificationInterval.optional(),
    ...
    profileTags: core.serialization.property(
      'ProfileTags',
      core.serialization
        .list(GetCommunitiesResponseResultsItemAddressesItemUserProfileTagsItem)
        .optional(),
    ),
    apiKey: core.serialization.property(
      'ApiKey',
      GetCommunitiesResponseResultsItemAddressesItemUserApiKey.optional(),
    ),
