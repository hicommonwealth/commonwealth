...
export declare const UpdateCommunityResponseContestManagersItemTopicsItem: core.serialization.ObjectSchema<
...
export declare namespace UpdateCommunityResponseContestManagersItemTopicsItem {
  interface Raw {
    ...
    contest_topics?:
      | UpdateCommunityResponseContestManagersItemTopicsItemContestTopicsItem.Raw[]
      | null;
  }
}
