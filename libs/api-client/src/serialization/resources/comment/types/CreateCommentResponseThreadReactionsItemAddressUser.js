...
export const CreateCommentResponseThreadReactionsItemAddressUser =
  core.serialization.object({
    ...
    emailNotificationInterval:
      CreateCommentResponseThreadReactionsItemAddressUserEmailNotificationInterval.optional(),
    ...
    profileTags: core.serialization.property(
      ...
      core.serialization
        .list(
          CreateCommentResponseThreadReactionsItemAddressUserProfileTagsItem,
        )
        .optional(),
    ),
    apiKey: core.serialization.property(
      'ApiKey',
      CreateCommentResponseThreadReactionsItemAddressUserApiKey.optional(),
    ),
