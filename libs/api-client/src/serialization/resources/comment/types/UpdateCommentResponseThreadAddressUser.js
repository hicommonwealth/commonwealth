...
export const UpdateCommentResponseThreadAddressUser = core.serialization.object(
  {
    ...
    emailNotificationInterval:
      UpdateCommentResponseThreadAddressUserEmailNotificationInterval.optional(),
    ...
    profileTags: core.serialization.property(
      'ProfileTags',
      core.serialization
        .list(UpdateCommentResponseThreadAddressUserProfileTagsItem)
        .optional(),
    ),
    apiKey: core.serialization.property(
      'ApiKey',
      UpdateCommentResponseThreadAddressUserApiKey.optional(),
    ),
