...
export const CreateCommentResponseReactionAddressUser =
  core.serialization.object({
    ...
    emailNotificationInterval:
      CreateCommentResponseReactionAddressUserEmailNotificationInterval.optional(),
    ...
    profileTags: core.serialization.property(
      'ProfileTags',
      core.serialization
        .list(CreateCommentResponseReactionAddressUserProfileTagsItem)
        .optional(),
    ),
    apiKey: core.serialization.property(
      'ApiKey',
      CreateCommentResponseReactionAddressUserApiKey.optional(),
    ),
