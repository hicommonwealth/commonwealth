...
exports.UpdateCommentResponseThreadTopic = void 0;
const core = __importStar(require('../../../../core'));
const UpdateCommentResponseThreadTopicWeightedVoting_1 = require('./UpdateCommentResponseThreadTopicWeightedVoting');
const UpdateCommentResponseThreadTopicContestTopicsItem_1 = require('./UpdateCommentResponseThreadTopicContestTopicsItem');
exports.UpdateCommentResponseThreadTopic = core.serialization.object({
  ...
  weightedVoting: core.serialization.property(
    'weighted_voting',
    UpdateCommentResponseThreadTopicWeightedVoting_1.UpdateCommentResponseThreadTopicWeightedVoting.optional(),
  ),
  ...
  contestTopics: core.serialization.property(
    ...
    core.serialization
      .list(
        UpdateCommentResponseThreadTopicContestTopicsItem_1.UpdateCommentResponseThreadTopicContestTopicsItem,
      )
      .optional(),
  ),
});
