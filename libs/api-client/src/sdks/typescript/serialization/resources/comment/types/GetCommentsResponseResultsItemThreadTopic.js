...
exports.GetCommentsResponseResultsItemThreadTopic = void 0;
const core = __importStar(require('../../../../core'));
const GetCommentsResponseResultsItemThreadTopicWeightedVoting_1 = require('./GetCommentsResponseResultsItemThreadTopicWeightedVoting');
const GetCommentsResponseResultsItemThreadTopicContestTopicsItem_1 = require('./GetCommentsResponseResultsItemThreadTopicContestTopicsItem');
exports.GetCommentsResponseResultsItemThreadTopic = core.serialization.object({
  ...
  weightedVoting: core.serialization.property(
    'weighted_voting',
    GetCommentsResponseResultsItemThreadTopicWeightedVoting_1.GetCommentsResponseResultsItemThreadTopicWeightedVoting.optional(),
  ),
  ...
  contestTopics: core.serialization.property(
    ...
    core.serialization
      .list(
        GetCommentsResponseResultsItemThreadTopicContestTopicsItem_1.GetCommentsResponseResultsItemThreadTopicContestTopicsItem,
      )
      .optional(),
  ),
});
