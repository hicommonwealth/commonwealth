...
exports.CreateCommentResponseThreadTopic = void 0;
const core = __importStar(require('../../../../core'));
const CreateCommentResponseThreadTopicWeightedVoting_1 = require('./CreateCommentResponseThreadTopicWeightedVoting');
const CreateCommentResponseThreadTopicContestTopicsItem_1 = require('./CreateCommentResponseThreadTopicContestTopicsItem');
exports.CreateCommentResponseThreadTopic = core.serialization.object({
  ...
  weightedVoting: core.serialization.property(
    'weighted_voting',
    CreateCommentResponseThreadTopicWeightedVoting_1.CreateCommentResponseThreadTopicWeightedVoting.optional(),
  ),
  ...
  contestTopics: core.serialization.property(
    ...
    core.serialization
      .list(
        CreateCommentResponseThreadTopicContestTopicsItem_1.CreateCommentResponseThreadTopicContestTopicsItem,
      )
      .optional(),
  ),
});
