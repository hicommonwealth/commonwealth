...
exports.CreateGroupResponseContestManagersItem = void 0;
const core = __importStar(require('../../../../core'));
const CreateGroupResponseContestManagersItemTopicsItem_1 = require('./CreateGroupResponseContestManagersItemTopicsItem');
const CreateGroupResponseContestManagersItemContestsItem_1 = require('./CreateGroupResponseContestManagersItemContestsItem');
exports.CreateGroupResponseContestManagersItem = core.serialization.object({
  ...
  topics: core.serialization
    .list(
      CreateGroupResponseContestManagersItemTopicsItem_1.CreateGroupResponseContestManagersItemTopicsItem,
    )
    .optional(),
  contests: core.serialization
    .list(
      CreateGroupResponseContestManagersItemContestsItem_1.CreateGroupResponseContestManagersItemContestsItem,
    )
    .optional(),
});
