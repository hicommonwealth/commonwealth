...
exports.CreateCommunityResponseCommunityTopicsItem = void 0;
const core = __importStar(require('../../../../core'));
const CreateCommunityResponseCommunityTopicsItemWeightedVoting_1 = require('./CreateCommunityResponseCommunityTopicsItemWeightedVoting');
const CreateCommunityResponseCommunityTopicsItemContestTopicsItem_1 = require('./CreateCommunityResponseCommunityTopicsItemContestTopicsItem');
exports.CreateCommunityResponseCommunityTopicsItem = core.serialization.object({
  ...
  weightedVoting: core.serialization.property(
    'weighted_voting',
    CreateCommunityResponseCommunityTopicsItemWeightedVoting_1.CreateCommunityResponseCommunityTopicsItemWeightedVoting.optional(),
  ),
  ...
  contestTopics: core.serialization.property(
    ...
    core.serialization
      .list(
        CreateCommunityResponseCommunityTopicsItemContestTopicsItem_1.CreateCommunityResponseCommunityTopicsItemContestTopicsItem,
      )
      .optional(),
  ),
});
