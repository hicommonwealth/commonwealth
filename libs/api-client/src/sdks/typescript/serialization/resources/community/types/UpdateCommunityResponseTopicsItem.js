...
exports.UpdateCommunityResponseTopicsItem = void 0;
const core = __importStar(require('../../../../core'));
const UpdateCommunityResponseTopicsItemWeightedVoting_1 = require('./UpdateCommunityResponseTopicsItemWeightedVoting');
const UpdateCommunityResponseTopicsItemContestTopicsItem_1 = require('./UpdateCommunityResponseTopicsItemContestTopicsItem');
exports.UpdateCommunityResponseTopicsItem = core.serialization.object({
  ...
  weightedVoting: core.serialization.property(
    'weighted_voting',
    UpdateCommunityResponseTopicsItemWeightedVoting_1.UpdateCommunityResponseTopicsItemWeightedVoting.optional(),
  ),
  ...
  contestTopics: core.serialization.property(
    ...
    core.serialization
      .list(
        UpdateCommunityResponseTopicsItemContestTopicsItem_1.UpdateCommunityResponseTopicsItemContestTopicsItem,
      )
      .optional(),
  ),
});
