...
exports.GetCommunityResponseAddressesTopicsItem = void 0;
const core = __importStar(require('../../../../core'));
const GetCommunityResponseAddressesTopicsItemWeightedVoting_1 = require('./GetCommunityResponseAddressesTopicsItemWeightedVoting');
const GetCommunityResponseAddressesTopicsItemContestTopicsItem_1 = require('./GetCommunityResponseAddressesTopicsItemContestTopicsItem');
exports.GetCommunityResponseAddressesTopicsItem = core.serialization.object({
  ...
  weightedVoting: core.serialization.property(
    'weighted_voting',
    GetCommunityResponseAddressesTopicsItemWeightedVoting_1.GetCommunityResponseAddressesTopicsItemWeightedVoting.optional(),
  ),
  ...
  contestTopics: core.serialization.property(
    ...
    core.serialization
      .list(
        GetCommunityResponseAddressesTopicsItemContestTopicsItem_1.GetCommunityResponseAddressesTopicsItemContestTopicsItem,
      )
      .optional(),
  ),
});
