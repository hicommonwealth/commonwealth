...
exports.CreateGroupResponseContestManagersItemTopicsItem = void 0;
const core = __importStar(require('../../../../core'));
const CreateGroupResponseContestManagersItemTopicsItemWeightedVoting_1 = require('./CreateGroupResponseContestManagersItemTopicsItemWeightedVoting');
const CreateGroupResponseContestManagersItemTopicsItemContestTopicsItem_1 = require('./CreateGroupResponseContestManagersItemTopicsItemContestTopicsItem');
exports.CreateGroupResponseContestManagersItemTopicsItem =
  core.serialization.object({
    ...
    weightedVoting: core.serialization.property(
      'weighted_voting',
      CreateGroupResponseContestManagersItemTopicsItemWeightedVoting_1.CreateGroupResponseContestManagersItemTopicsItemWeightedVoting.optional(),
    ),
    ...
    contestTopics: core.serialization.property(
      ...
      core.serialization
        .list(
          CreateGroupResponseContestManagersItemTopicsItemContestTopicsItem_1.CreateGroupResponseContestManagersItemTopicsItemContestTopicsItem,
        )
        .optional(),
    ),
  });
