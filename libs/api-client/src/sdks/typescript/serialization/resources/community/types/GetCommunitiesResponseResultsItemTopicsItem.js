...
exports.GetCommunitiesResponseResultsItemTopicsItem = void 0;
const core = __importStar(require('../../../../core'));
const GetCommunitiesResponseResultsItemTopicsItemWeightedVoting_1 = require('./GetCommunitiesResponseResultsItemTopicsItemWeightedVoting');
const GetCommunitiesResponseResultsItemTopicsItemContestTopicsItem_1 = require('./GetCommunitiesResponseResultsItemTopicsItemContestTopicsItem');
exports.GetCommunitiesResponseResultsItemTopicsItem = core.serialization.object(
  {
    ...
    weightedVoting: core.serialization.property(
      'weighted_voting',
      GetCommunitiesResponseResultsItemTopicsItemWeightedVoting_1.GetCommunitiesResponseResultsItemTopicsItemWeightedVoting.optional(),
    ),
    ...
    contestTopics: core.serialization.property(
      ...
      core.serialization
        .list(
          GetCommunitiesResponseResultsItemTopicsItemContestTopicsItem_1.GetCommunitiesResponseResultsItemTopicsItemContestTopicsItem,
        )
        .optional(),
    ),
  },
