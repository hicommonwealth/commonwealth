...
exports.CreateTopicResponseTopic = void 0;
const core = __importStar(require('../../../../core'));
const CreateTopicResponseTopicWeightedVoting_1 = require('./CreateTopicResponseTopicWeightedVoting');
const CreateTopicResponseTopicContestTopicsItem_1 = require('./CreateTopicResponseTopicContestTopicsItem');
exports.CreateTopicResponseTopic = core.serialization.object({
  ...
  weightedVoting: core.serialization.property(
    'weighted_voting',
    CreateTopicResponseTopicWeightedVoting_1.CreateTopicResponseTopicWeightedVoting.optional(),
  ),
  ...
  contestTopics: core.serialization.property(
    ...
    core.serialization
      .list(
        CreateTopicResponseTopicContestTopicsItem_1.CreateTopicResponseTopicContestTopicsItem,
      )
      .optional(),
  ),
});
