...
exports.UpdateTopicResponseTopic = void 0;
const core = __importStar(require('../../../../core'));
const UpdateTopicResponseTopicWeightedVoting_1 = require('./UpdateTopicResponseTopicWeightedVoting');
const UpdateTopicResponseTopicContestTopicsItem_1 = require('./UpdateTopicResponseTopicContestTopicsItem');
exports.UpdateTopicResponseTopic = core.serialization.object({
  ...
  weightedVoting: core.serialization.property(
    'weighted_voting',
    UpdateTopicResponseTopicWeightedVoting_1.UpdateTopicResponseTopicWeightedVoting.optional(),
  ),
  ...
  contestTopics: core.serialization.property(
    ...
    core.serialization
      .list(
        UpdateTopicResponseTopicContestTopicsItem_1.UpdateTopicResponseTopicContestTopicsItem,
      )
      .optional(),
  ),
});
