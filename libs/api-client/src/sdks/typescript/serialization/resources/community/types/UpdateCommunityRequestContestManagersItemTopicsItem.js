...
exports.UpdateCommunityRequestContestManagersItemTopicsItem = void 0;
const core = __importStar(require('../../../../core'));
const UpdateCommunityRequestContestManagersItemTopicsItemWeightedVoting_1 = require('./UpdateCommunityRequestContestManagersItemTopicsItemWeightedVoting');
const UpdateCommunityRequestContestManagersItemTopicsItemContestTopicsItem_1 = require('./UpdateCommunityRequestContestManagersItemTopicsItemContestTopicsItem');
exports.UpdateCommunityRequestContestManagersItemTopicsItem =
  core.serialization.object({
    ...
    weightedVoting: core.serialization.property(
      'weighted_voting',
      UpdateCommunityRequestContestManagersItemTopicsItemWeightedVoting_1.UpdateCommunityRequestContestManagersItemTopicsItemWeightedVoting.optional(),
    ),
    ...
    contestTopics: core.serialization.property(
      ...
      core.serialization
        .list(
          UpdateCommunityRequestContestManagersItemTopicsItemContestTopicsItem_1.UpdateCommunityRequestContestManagersItemTopicsItemContestTopicsItem,
        )
        .optional(),
    ),
  });
