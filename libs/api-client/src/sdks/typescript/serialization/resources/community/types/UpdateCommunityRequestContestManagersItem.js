...
exports.UpdateCommunityRequestContestManagersItem = void 0;
const core = __importStar(require('../../../../core'));
const UpdateCommunityRequestContestManagersItemTopicsItem_1 = require('./UpdateCommunityRequestContestManagersItemTopicsItem');
const UpdateCommunityRequestContestManagersItemContestsItem_1 = require('./UpdateCommunityRequestContestManagersItemContestsItem');
exports.UpdateCommunityRequestContestManagersItem = core.serialization.object({
  ...
  topics: core.serialization
    .list(
      UpdateCommunityRequestContestManagersItemTopicsItem_1.UpdateCommunityRequestContestManagersItemTopicsItem,
    )
    .optional(),
  contests: core.serialization
    .list(
      UpdateCommunityRequestContestManagersItemContestsItem_1.UpdateCommunityRequestContestManagersItemContestsItem,
    )
    .optional(),
});
