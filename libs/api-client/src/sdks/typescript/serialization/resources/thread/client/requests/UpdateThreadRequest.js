...
const UpdateThreadRequestCollaborators_1 = require('../../types/UpdateThreadRequestCollaborators');
exports.UpdateThreadRequest = core.serialization.object({
  ...
  collaborators:
    UpdateThreadRequestCollaborators_1.UpdateThreadRequestCollaborators.optional(),
