...
exports.UpdateThreadResponseTopic = void 0;
const core = __importStar(require('../../../../core'));
const UpdateThreadResponseTopicWeightedVoting_1 = require('./UpdateThreadResponseTopicWeightedVoting');
const UpdateThreadResponseTopicContestTopicsItem_1 = require('./UpdateThreadResponseTopicContestTopicsItem');
exports.UpdateThreadResponseTopic = core.serialization.object({
  ...
  weightedVoting: core.serialization.property(
    'weighted_voting',
    UpdateThreadResponseTopicWeightedVoting_1.UpdateThreadResponseTopicWeightedVoting.optional(),
  ),
  ...
  contestTopics: core.serialization.property(
    ...
    core.serialization
      .list(
        UpdateThreadResponseTopicContestTopicsItem_1.UpdateThreadResponseTopicContestTopicsItem,
      )
      .optional(),
  ),
});
