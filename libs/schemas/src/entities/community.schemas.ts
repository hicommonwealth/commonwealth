...
export const Community = z.object({
  ...
  social_links: z.array(z.string()).nullish(),
  ss58_prefix: PG_INT.nullish(),
  stages_enabled: z.boolean().default(true).nullish(),
  custom_stages: z.array(z.string()).default([]).nullish(),
  custom_domain: z.string().nullish(),
  block_explorer_ids: z.string().nullish(),
  collapsed_on_homepage: z.boolean().default(false).nullish(),
  substrate_spec: z.string().nullish(),
  has_chain_events_listener: z.boolean().default(false).nullish(),
  default_summary_view: z.boolean().nullish(),
  default_page: z.nativeEnum(DefaultPage).nullish(),
  has_homepage: z.enum(['true', 'false']).nullish().default('false').nullish(),
  ...
  directory_page_enabled: z.boolean().default(false).nullish(),
  ...
  snapshot_spaces: z.array(z.string().max(255)).default([]).nullish(),
