...
export const Community = z.object({
  ...
  stages_enabled: z.boolean().nullish(),
  custom_stages: z.array(z.string()).nullish(),
  custom_domain: z.string().nullish(),
  block_explorer_ids: z.string().nullish(),
  collapsed_on_homepage: z.boolean().nullish(),
  substrate_spec: z.string().nullish(),
  has_chain_events_listener: z.boolean().nullish(),
