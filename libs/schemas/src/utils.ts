...
export const EVM_ADDRESS_STRICT = z.string().regex(EVM_ADDRESS_STRICT_REGEX);
export const EVM_EVENT_SIGNATURE_STRICT = z
  .string()
  .regex(EVM_EVENT_SIGNATURE_STRICT_REGEX);
export const EVM_BYTES = z.string().regex(/^0x[0-9a-fA-F]*$/);

// @timolegros let's reivew this, should we use the new temaplte literal types?
// -> custom is not supported by openapi generator
