...
export const EVM_ADDRESS_STRICT_REGEX = /^[0-9a-fA-F]{40}$/;

export const EVM_EVENT_SIGNATURE_STRICT_REGEX = /^[0-9a-fA-F]{64}$/;
...
export const EVM_ADDRESS_STRICT = z.templateLiteral([
  z.literal('0x'),
  z.string().regex(EVM_ADDRESS_STRICT_REGEX),
]);
export const EVM_EVENT_SIGNATURE_STRICT = z.templateLiteral([
  z.literal('0x'),
  z.string().regex(EVM_EVENT_SIGNATURE_STRICT_REGEX),
]);
