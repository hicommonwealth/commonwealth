...
export const TxResponse = {
  ...
  fromSDK(object: TxResponseSDKType): TxResponse {
    return {
      ...
      logs: Array.isArray(object?.logs)
        ? object.logs.map((e: any) => ABCIMessageLog.fromSDK(e))
        : [],
...
export const ABCIMessageLog = {
  ...
  fromSDK(object: ABCIMessageLogSDKType): ABCIMessageLog {
    return {
      ...
      events: Array.isArray(object?.events)
        ? object.events.map((e: any) => StringEvent.fromSDK(e))
        : [],
    };
  },
};
...
export const StringEvent = {
  ...
  fromSDK(object: StringEventSDKType): StringEvent {
    return {
      ...
      attributes: Array.isArray(object?.attributes)
        ? object.attributes.map((e: any) => Attribute.fromSDK(e))
        : [],
    };
  },
};
  ...
  fromSDK(object: ResultSDKType): Result {
    return {
      ...
      events: Array.isArray(object?.events)
        ? object.events.map((e: any) => Event.fromSDK(e))
        : [],
      msgResponses: Array.isArray(object?.msg_responses)
        ? object.msg_responses.map((e: any) => Any.fromSDK(e))
        : [],
    };
  },
};
...
export const SimulationResponse = {
  ...
  fromSDK(object: SimulationResponseSDKType): SimulationResponse {
    return {
      gasInfo: isSet(object.gas_info)
        ? GasInfo.fromSDK(object.gas_info)
        : undefined,
...
export const TxMsgData = {
  ...
  fromSDK(object: TxMsgDataSDKType): TxMsgData {
    return {
      data: Array.isArray(object?.data)
        ? object.data.map((e: any) => MsgData.fromSDK(e))
        : [],
      msgResponses: Array.isArray(object?.msg_responses)
        ? object.msg_responses.map((e: any) => Any.fromSDK(e))
        : [],
...
export const SearchTxsResult = {
  ...
  fromSDK(object: SearchTxsResultSDKType): SearchTxsResult {
    return {
      ...
      txs: Array.isArray(object?.txs)
        ? object.txs.map((e: any) => TxResponse.fromSDK(e))
        : [],
    };
  },
};
