...
export const BlockID = {
  ...
  fromSDK(object: BlockIDSDKType): BlockID {
    return {
      hash: isSet(object.hash) ? object.hash : undefined,
      partSetHeader: isSet(object.part_set_header)
        ? PartSetHeader.fromSDK(object.part_set_header)
        : undefined,
    };
  },
};
...
export const Header = {
  ...
  fromSDK(object: HeaderSDKType): Header {
    return {
      version: isSet(object.version)
        ? Consensus.fromSDK(object.version)
        : undefined,
      ...
      lastBlockId: isSet(object.last_block_id)
        ? BlockID.fromSDK(object.last_block_id)
        : undefined,
      lastCommitHash: isSet(object.last_commit_hash)
      ...
      nextValidatorsHash: isSet(object.next_validators_hash)
        ...
        : undefined,
      consensusHash: isSet(object.consensus_hash)
        ? object.consensus_hash
        : undefined,
      appHash: isSet(object.app_hash) ? object.app_hash : undefined,
      lastResultsHash: isSet(object.last_results_hash)
        ? object.last_results_hash
        : undefined,
      evidenceHash: isSet(object.evidence_hash)
        ? object.evidence_hash
        : undefined,
      proposerAddress: isSet(object.proposer_address)
...
export const Vote = {
  ...
  fromSDK(object: VoteSDKType): Vote {
    return {
      ...
      blockId: isSet(object.block_id)
        ? BlockID.fromSDK(object.block_id)
        : undefined,
      timestamp: isSet(object.timestamp)
        ? Timestamp.fromSDK(object.timestamp)
        : undefined,
      validatorAddress: isSet(object.validator_address)
        ? object.validator_address
        : undefined,
      validatorIndex: isSet(object.validator_index)
        ? object.validator_index
        : undefined,
  ...
  fromSDK(object: CommitSDKType): Commit {
    return {
      ...
      blockId: isSet(object.block_id)
        ...
        : undefined,
      signatures: Array.isArray(object?.signatures)
        ? object.signatures.map((e: any) => CommitSig.fromSDK(e))
        : [],
    };
  },
};
...
export const LightBlock = {
  ...
  fromSDK(object: LightBlockSDKType): LightBlock {
    return {
      signedHeader: isSet(object.signed_header)
        ? SignedHeader.fromSDK(object.signed_header)
        : undefined,
      validatorSet: isSet(object.validator_set)
        ? ValidatorSet.fromSDK(object.validator_set)
        : undefined,
    };
  },
};
