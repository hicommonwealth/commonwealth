export const referralFeeManager = [
  {
    inputs: [
      { internalType: 'address', name: 'namespaceFactory', type: 'address' },
      { internalType: 'address', name: 'owner', type: 'address' },
      { internalType: 'uint256', name: 'initialFeeSplit', type: 'uint256' },
      {
        internalType: 'address',
        name: 'initialProtocolFeeDestination',
        type: 'address',
      },
    ],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'newSplitPercentage', type: 'uint256' },
    ],
    name: 'setFeeSplit',
    outputs: [],
    stateMutability: 'nonpayable',
