import z, { ZodObject, ZodRawShape, ZodUndefined } from 'zod';
 ...
 */
export type Schemas<
  Input extends ZodObject<ZodRawShape> = ZodObject<ZodRawShape>,
  Output extends ZodObject<ZodRawShape> = ZodObject<ZodRawShape>,
> = {
