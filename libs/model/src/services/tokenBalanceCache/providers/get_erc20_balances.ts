console.log(
  'LOADING src/services/tokenBalanceCache/providers/get_erc20_balances.ts START',
);
...
console.log(
  'LOADING src/services/tokenBalanceCache/providers/get_erc20_balances.ts END',
);
