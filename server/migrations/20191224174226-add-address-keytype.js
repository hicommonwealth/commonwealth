...
module.exports = {
  ...
  down: async (queryInterface, Sequelize) => {
    const toDelete = await queryInterface.sequelize.query(`SELECT id FROM "Addresses" WHERE keytype IS NOT NULL`);
    ...
    return queryInterface.sequelize.transaction(async (t) => {
      ...
      await queryInterface.bulkDelete('Addresses', { id: ids }, { transaction: t });
    }).then(() => {
