...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.sequelize.transaction(async (t) => {
      ...
      await queryInterface.bulkInsert('ChainNodes', molochDAOAddresses, { transaction: t });
    });
  },
  ...
  down: (queryInterface, Sequelize) => {
    return queryInterface.sequelize.transaction(async (t) => {
      ...
      await queryInterface.bulkDelete('Chains', { id: molochDAOs.map(r => r.id) }, { transaction: t });
      await queryInterface.bulkDelete('ChainNodes', { id: molochDAOAddresses.map(r => r.id) }, { transaction: t });
    });
  }
};
