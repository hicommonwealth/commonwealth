...
module.exports = {
  ...
  down: (queryInterface, Sequelize) => {
    return queryInterface.sequelize.transaction(async (t) => {
      await queryInterface.bulkDelete('ChainNodes', { chain: 'injective-testnet' }, { transaction: t });
      await queryInterface.bulkDelete('Chains', { id: ['injective-testnet'] }, { transaction: t });
    });
  }
};
