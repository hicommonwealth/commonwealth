  ...
  up: (queryInterface, Sequelize) => {
    return queryInterface.sequelize.transaction(async (t) => {
      ...
      await queryInterface.bulkInsert('ChainNodes', [{
        chain: 'injective',
        url: 'wss://public-rpc.injective.network:26657',
      }], { transaction: t });
    });
  },
  down: (queryInterface, Sequelize) => {
    return queryInterface.sequelize.transaction(async (t) => {
      await queryInterface.bulkDelete('ChainNodes', { chain: 'injective' }, { transaction: t });
      await queryInterface.bulkDelete('Chains', { id: ['injective'] }, { transaction: t });
    });
  }
};
