...
export type EdgewareLockdropEventInstance =
  ModelInstance<EdgewareLockdropEventAttributes>;

export type EdgewareLockdropEventModelStatic =
  ModelStatic<EdgewareLockdropEventInstance>;

export default (
  sequelize: Sequelize.Sequelize,
  dataTypes: typeof DataTypes
): EdgewareLockdropEventModelStatic => {
  const EdgewareLockdropEvent = <EdgewareLockdropEventModelStatic>(
    sequelize.define(
