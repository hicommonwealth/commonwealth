...
export interface WaitlistRegistrationInstance
  extends Sequelize.Instance<WaitlistRegistrationAttributes>,
    WaitlistRegistrationAttributes {}

export type WaitlistRegistrationModel = Sequelize.Model<
...
export default (
  ...
  const WaitlistRegistration = sequelize.define<
    WaitlistRegistrationInstance,
    WaitlistRegistrationAttributes
  >(
