...
extends Model<ChainCategoryTypeAttributes>, ChainCategoryTypeAttributes {}

export type ChainCategoryTypeModelStatic = ModelStatic<ChainCategoryTypeInstance>

export default (
  sequelize: Sequelize.Sequelize,
  dataTypes: typeof DataTypes,
): ChainCategoryTypeModelStatic => {
  const ChainCategoryType = <ChainCategoryTypeModelStatic>sequelize.define('ChainCategoryType', {
