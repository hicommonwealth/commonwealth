...
export interface ChainEventInstance
  extends Sequelize.Instance<ChainEventAttributes>,
    ChainEventAttributes {}

export type ChainEventModel = Sequelize.Model<
  ChainEventInstance,
  ChainEventAttributes
>;
...
export default (
  ...
  const ChainEvent = sequelize.define<ChainEventInstance, ChainEventAttributes>(
    'ChainEvent',
    {
