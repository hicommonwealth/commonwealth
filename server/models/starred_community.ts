...
export interface StarredCommunityInstance
  extends Sequelize.Instance<StarredCommunityAttributes>,
    StarredCommunityAttributes {
  // no mixins used
}

export type StarredCommunityModel = Sequelize.Model<
  StarredCommunityInstance,
  StarredCommunityAttributes
>;
...
export default (
  ...
  const StarredCommunity = sequelize.define<
    StarredCommunityInstance,
    StarredCommunityAttributes
  >(
    'StarredCommunity',
  ...
  StarredCommunity.associate = (models) => {
    ...
    models.StarredCommunity.belongsTo(models.OffchainCommunity, {
