...
export interface WebhookInstance
  extends Sequelize.Instance<WebhookAttributes>,
    WebhookAttributes {}

export type WebhookModel = Sequelize.Model<WebhookInstance, WebhookAttributes>;

export default (
  sequelize: Sequelize.Sequelize,
  dataTypes: Sequelize.DataTypes
): WebhookModel => {
  const Webhook = sequelize.define<WebhookInstance, WebhookAttributes>(
    'Webhook',
    {
    ...
    },
    {
      ...
      validate: {
        ...
        eitherOffchainOrOnchain() {
          ...
          if (this.chain_id && this.offchain_community_id) {
            throw new Error(
              'Either chain_id or offchain_community_id not both!'
            );
          }
        },
      },
  ...
  Webhook.associate = (models) => {
    ...
    models.Webhook.belongsTo(models.OffchainCommunity, {
      foreignKey: 'offchain_community_id',
      targetKey: 'id',
    });
  };
