...
export type InviteCodeModel = Sequelize.Model<
  InviteCodeInstance,
  InviteCodeAttributes
>;
...
export default (
  ...
  const InviteCode = sequelize.define<InviteCodeInstance, InviteCodeAttributes>(
    'InviteCode',
    {
  ...
  InviteCode.associate = (models) => {
    models.InviteCode.belongsTo(models.OffchainCommunity, {
      foreignKey: 'community_id',
      targetKey: 'id',
    });
    models.InviteCode.belongsTo(models.Chain, {
      foreignKey: 'chain_id',
      targetKey: 'id',
    });
  };
