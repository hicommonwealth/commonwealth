...
export type NotificationModel = Sequelize.Model<
...
export default (
  ...
  Notification.associate = (models) => {
    models.Notification.belongsTo(models.Subscription, {
      foreignKey: 'subscription_id',
      targetKey: 'id',
    });
    models.Notification.belongsTo(models.ChainEvent, {
      foreignKey: 'chain_event_id',
      targetKey: 'id',
    });
  };
