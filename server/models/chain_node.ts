...
export interface ChainNodeInstance
  extends Sequelize.Instance<ChainNodeAttributes>,
    ChainNodeAttributes {
  // TODO: add mixins as needed
  getChain: Sequelize.BelongsToGetAssociationMixin<ChainInstance>;
}

export type ChainNodeModel = Sequelize.Model<
  ChainNodeInstance,
  ChainNodeAttributes
>;
...
export default (
  ...
  const ChainNode = sequelize.define<ChainNodeInstance, ChainNodeAttributes>(
    'ChainNode',
    {
