...
import OffchainStageFactory, { OffchainStageModelStatic } from './models/offchain_stage';
...
export type Models = {
    ...
    OffchainStage: OffchainStageModelStatic;
...
const models: Models = {
  ...
  OffchainStage: OffchainStageFactory(sequelize, DataTypes),
