...
const nodes = [
  ...
  [
    'wss://eth-mainnet.alchemyapi.io/v2/cNC4XfxR7biwO2bfIO5aKcs9EMPxTQfr',
    'marlin',
    '0xEa2923b099b4B588FdFAD47201d747e3b9599A5f',
  ],
  [
    'ws://127.0.0.1:9545',
    'marlin-local',
    '0xe0D6a92B91B83D5c8A95557f1c966cAFd97f7171',
  ],
  [
    'wss://eth-mainnet.alchemyapi.io/v2/cNC4XfxR7biwO2bfIO5aKcs9EMPxTQfr',
    'aave',
    ...
    models.sequelize
      ...
      .then(async () => {
        ...
        await Promise.all(
          chains
            .map((chain) =>
              models.OffchainTopic.create({
                name: 'General',
                description:
                  "General discussion about this blockchain's chain development and governance",
                chain_id: chain.id,
              })
            )
            .concat(
...
async function main() {
  if (!process.argv.slice(2).includes('-y')) {
    ...
    console.log(
      "Unless you know what you're doing, please use `yarn reset-db && yarn load-db` instead."
    );
